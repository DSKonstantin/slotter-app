...
export const mockSchedule: Schedule[] = [
  ...
  },
  {
    ...
    timeEnd: `${todayStr}T14:00:00.000Z`,
    status: "available",
  },
  {
    id: "5",
    ...
    timeEnd: `${todayStr}T15:15:00.000Z`,
    price: 4000,
    status: "confirmed",
  ...
  },
  {
    ...
    price: 3500,
    status: "confirmed",
    services: ["Стрижка + укладка", "+ 2 доп."],
  },
  {
    id: "8",
    clientName: "Кристина Соловьева",
    timeStart: `${dayAfterTomorrowStr}T15:15:00.000Z`,
    timeEnd: `${dayAfterTomorrowStr}T16:30:00.000Z`,
    price: 3000,
    status: "pending",
    services: ["Укладка", "Укладка 2", "Укладка 3"],
  },
  {
    id: "9",
    timeStart: `${todayStr}T14:00:00.000Z`,
